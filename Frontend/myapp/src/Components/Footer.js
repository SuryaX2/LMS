                ...
                <div className="-m-8 flex flex-wrap items-center justify-between">
                    <div className="w-auto p-8">
                        <ul className="-m-5 flex flex-wrap items-center">
                            <li className="p-5">
                                <a className="font-medium text-gray-600 hover:text-gray-700 no-underline" href="/signup">
                                    Sign Up
                                </a>
                            </li>
                            <li className="p-5">
                                <a className="font-medium text-gray-600 hover:text-gray-700 no-underline" href="/login">
                                    Login
                                </a>
                            </li>
                            <li className="p-5">
                                <a className="font-medium text-gray-600 hover:text-gray-700 no-underline" href="https://github.com/SuryaX2/">
                                    Contact Us
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className="w-auto p-8">
                        <div className="-m-1.5 flex flex-wrap">
                            ...
                            <div className="w-auto p-1.5">
                                <a href="https://github.com/SuryaX2/">
                                    <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                                        <svg
                                            width="14"
                                            height="11"
