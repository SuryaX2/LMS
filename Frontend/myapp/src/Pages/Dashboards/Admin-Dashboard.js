            ...
            <div className="modal-content bg-white rounded-lg overflow-hidden shadow-lg">
              ...
              <Modal.Body className="p-0">
                <div className="flex h-[500px]">
                  ...
                  <div className="w-3/5 p-4 bg-white flex flex-col justify-between">
                    <div>
                      <h2 className="text-2xl font-bold mb-1 text-gray-800">{viewingBook?.title}</h2>
                      <p className="text-lg text-gray-600 mb-2 italic">By {viewingBook?.author}</p>
                      <div className="w-12 h-1 bg-blue-500 mb-3"></div>
                      <div className="space-y-2">
                        <p className="text-xs text-gray-500 uppercase tracking-wide">Book Information</p>
